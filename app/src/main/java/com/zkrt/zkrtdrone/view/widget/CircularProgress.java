...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VerticalTabLayout, defStyleAttr, 0);
        mBorderWidth = a.getDimension(R.styleable.VerticalTabLayout_borderWidth,
